...
pub enum LocalControlPermission {
    LocalReadOnlyMetadata,
    TerminalDataReads,
    NonDestructiveLocalMutations,
    DestructiveOrExecutionActions,
...
impl ActionKind {
    ...
    pub fn metadata(self) -> ActionMetadata {
        if self == Self::TabCreate {
            return ActionMetadata {
                ...
                permission: LocalControlPermission::NonDestructiveLocalMutations,
    ...
    fn default_permission(self) -> LocalControlPermission {
        match self.default_risk_tier() {
            RiskTier::ReadOnlyMetadata => LocalControlPermission::LocalReadOnlyMetadata,
            RiskTier::ReadOnlyTerminalData => LocalControlPermission::TerminalDataReads,
            RiskTier::MutatingNonDestructive => {
                LocalControlPermission::NonDestructiveLocalMutations
            }
            RiskTier::MutatingDestructiveOrExecution => {
                LocalControlPermission::DestructiveOrExecutionActions
            }
        }
    }
